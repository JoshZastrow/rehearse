...
| [`v2026-05-06-r6-reliability-backlog.md`](v2026-05-06-r6-reliability-backlog.md) | `wip` | `implementation` | R6 runtime reliability punch list | Items 1 (stream WAV to disk, commit 5d89572) and 3 (finalize sweeper, commit b6c5242) shipped. Items 2 (Hume reconnect with backoff) and 4 (persist SessionHandle across restarts) still open. Promote each remaining item to its own design spec when picked up. |
