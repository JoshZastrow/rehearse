...
| [`v2026-05-11-live-audio-eval-sandbox.md`](v2026-05-11-live-audio-eval-sandbox.md) | `done` | `implementation` | Live-audio eval environment | Fully shipped: `LiveAudioSandboxEnvironment`, `HumeEVIAdapter`, `AudioCustomerDriver`, all audio frame routing. Run with `make eval-voice-rollout-audio` for real naturalness scores. |
