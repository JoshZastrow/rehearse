...
Also contains InProcessExecutor for running rollouts in the harness process
(used when test fixtures or --verbose live event streaming is needed).
"""
